...
import { Center, Heading, Box, View, Button, VStack, FormControl, Input, HStack, Link, Text, Spacer } from "native-base";
    ...
    <>
      <Box bg="white">
        <HStack alignItems={"center"} px={5} py={2}>
          ...
          <Spacer/>
          <Button onPress={() => props.navigation.navigate('Home')}>돌아가기</Button>
        </HStack>
      </Box>
