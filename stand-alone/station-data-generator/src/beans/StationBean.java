...
public class StationBean {
    ...
    public String getCharging_station_location_street() {
        return charging_station_location_street;
    }

    public void setCharging_station_location_street(String charging_station_location_street) {
        this.charging_station_location_street = charging_station_location_street;
    }

    public String getCharging_station_location_land() {
        return charging_station_location_land;
    }

    public void setCharging_station_location_land(String charging_station_location_land) {
        this.charging_station_location_land = charging_station_location_land;
    }
